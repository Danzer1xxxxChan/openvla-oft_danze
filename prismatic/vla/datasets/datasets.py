...
class RLDSBatchTransform:
    ...
    def __call__(self, rlds_batch: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.showlab_franka:
            # print(f"Cropping right square for showlab_franka dataset: {dataset_name}")
            img = crop_right_square(img)
        lang = rlds_batch["task"]["language_instruction"].decode().lower()
        #print(f"lang in place phone is : {lang} and dataset_name is {dataset_name}",flush=True)
        ...
        # cnt = 0
        # cnt_256 = 0
        # for i in range(len(labels) - 3, -1, -7):
        #     cnt += 1
        #     if labels[i] == 31744:
        #         cnt_256 += 1
        #     if cnt == 24:
        ...
        # percentage = (cnt_256 / cnt * 100)
        # print(f"Percentage of 31744 in the selected positions: {percentage:.2f}%")
...
if __name__ == '__main__':
    ...
    train_dataset = RLDSDataset(
        "/mnt/bn/vgfm2/test_dit/zechen/DATA/Robo/LIBERO/modified_libero_rlds",
